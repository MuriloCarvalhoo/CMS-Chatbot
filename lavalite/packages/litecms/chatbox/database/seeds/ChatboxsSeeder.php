...
class ChatboxsSeeder extends Seeder
{
    public function run()
    {
        DB::table(config('litecms.chatbox.chatbox.table'))->insert([
            ...
            [
                'id'               => 4,
                'name'             => 'chatbox Not found',
                'heading'          => 'chatbox Not found',
                'title'            => 'chatbox Not found',
                'content'          => '<p><br></p>',
                'meta_title'       => 'chatbox Not found',
                'meta_keyword'     => 'chatbox Not found',
                'meta_description' => 'chatbox Not found',
                'images'           => null,
                'abstract'         => null,
                'slug'             => 404,
                'order'            => 0,
        ...
        DB::table('permissions')->insert([
            [
                'slug' => 'chatbox.chatbox.view',
                'name' => 'View chatbox',
            ],
            [
                'slug' => 'chatbox.chatbox.create',
                'name' => 'Create chatbox',
            ],
            [
                'slug' => 'chatbox.chatbox.edit',
                'name' => 'Update chatbox',
            ],
            [
                'slug' => 'chatbox.chatbox.delete',
                'name' => 'Delete chatbox',
            ],
        ]);
    }
