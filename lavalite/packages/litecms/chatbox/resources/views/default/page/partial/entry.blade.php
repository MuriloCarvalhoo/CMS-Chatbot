            ...
            <div class="app-entry-form-section" id="settings">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        {!! Form::select('view')
                        -> options(trans('chatbox::chatbox.options.view'))
                        -> label(trans('chatbox::chatbox.label.view'))
                        -> placeholder(trans('chatbox::chatbox.placeholder.view'))
                        !!}
                        ...
                        {!! Form::select('compile')
                        -> options(trans('chatbox::chatbox.options.compile'))
                        -> label(trans('chatbox::chatbox.label.compile'))
                        -> placeholder(trans('chatbox::chatbox.placeholder.compile'))
                        !!}

                        {!! Form::select('category_id')
                        -> options(trans('chatbox::chatbox.options.category'))
                        -> label(trans('chatbox::chatbox.label.category_id'))
                        -> placeholder(trans('chatbox::chatbox.placeholder.category_id'))
                        !!}

                        {!! Form::select('status')
                        -> options(trans('chatbox::chatbox.options.status'))
                        -> label(trans('chatbox::chatbox.label.status'))
                        -> placeholder(trans('chatbox::chatbox.placeholder.status'))
                        !!}
                    </div>
                </div>
            </div>
