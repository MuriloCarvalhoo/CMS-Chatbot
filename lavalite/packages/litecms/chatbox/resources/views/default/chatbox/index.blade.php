    ...
    <div class="app-list-inner">
        <div class="app-list-header d-flex align-items-center justify-content-between">
            ...
            <button type="button" class="btn add-app-btn btn-icon btn-outline" data-action='CREATE'
                data-load-to="#app-entry" data-url="{{guard_url('chatbox/chatbox/create')}}">
        ...
        <div class="app-list-wrap-inner ps ps--active-y" id="app-list">
            <div class="app-list-toolbar">
                <div class="app-list-pagination" id="app-paginate">
                    ...
                    &nbsp;
                    <span class="mr-5" id="paginate-number">chatbox 1 of {{$meta['pagination']['total_pages']}}</span>
                    <a href="#" class="chatbox-previous"><i class="las la-angle-left"></i></a>
                    <a href="#" class="chatbox-next"><i class="las la-angle-right"></i></a>
                </div>
                <div class="dropdown">
            ...
            <div class="app-items" data-url="{{guard_url('chatbox/chatbox')}}" id="item-list">
                @include('chatbox::chatbox.more', ['mode' => 'list'])
            </div>
...
<script type="">
    var module_link = "{{guard_url('chatbox/chatbox')}}";
