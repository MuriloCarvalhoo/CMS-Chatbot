                ...
                <div class="row">
                   <div class="col-auto">
                        <div class="form-group">
                          ...
                          <input type="hidden" name="tipo[]" id="tipo" value="Anexo">
                          <input type="text" class="form-control" disabled="true" value="Anexo">
                        </div>
                        <div class="form-group">
                          <label for="nome[]" class="control-label">Nome da função</label>
                          <input type="text" class="form-control" name="nome[]" id="nome" placeholder="Ex: 'email'" value="{{ $data->nome }}" >
                        </div>
                   </div>
                   <div class="col-auto">
                        <div class="form-group">
                          <label for="ouvir[]" class="control-label">Ouvir:</label>
                          <input type="text" class="form-control" name="ouvir[]" id="ouvir" placeholder="Ex: 'Quero o meu extrato' " value="{{ $data->ouvir }}" >
                        </div>
                      <div class="form-group">
                         <label for="validar[]" class="control-label">Validação</label>
                         <input type="hidden" name="validar[]" id="validar">
                         <select type="text" class="form-control" disabled="true">
                   ...
                   <div class="col-auto">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="pergunta[]" id="pergunta" placeholder="Ex: 'Qual o seu email ? '" value="{{ $data->pergunta }}" >
                        </div>
                        <div class="form-group">
                            <label for="resposta[]" class="control-label">Resposta:</label>
                            <input type="text" class="form-control" name="resposta[]" id="resposta" placeholder="Ex: 'Seu e-mail é '"  value="{{ $data->resposta }}" >
                        </div>
                   </div>
                   <div class="col-auto">
                        <div class="form-group">
                            <label for="nome_prox[]" class="control-label">Nome da proxima função:</label>
                            <input type="text" class="form-control" name="nome_prox[]" id="nome_prox" placeholder="Ex: 'cpf'"  value="{{ $data->nome_prox }}" >
                        </div>
                   </div>
                </div>
             </div>
