...
<div class="row pl-15 pr-15 pb-30">
    ...
    <div class="row g-0">
        ...
        <form action="{{ route('respostas.store') }}" method="post">
            @csrf
            <label for="nome">Crie uma resposta para o Robo: </label>
            <input type="text" name="resposta" value="{{ old('resposta') }}">
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <a href="{{ route('respostas.index') }}" class="bg-grey-500 font-semibold rounded-lg shadow-md hover:bg-grey-900 focus:outline-none focus:ring-2 focus:ring-grey-400 focus:ring-opacity-75">Voltar</a>
        </button> 
    </div>
