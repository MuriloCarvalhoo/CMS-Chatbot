			...
			(function (e) {
				(function (t, n) {
					...
					var He = ["background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href"],
						...
						Qe = /^data:(?:image\/(?:bmp|gif|jpeg|jpg|png|tiff|webp)|video\/(?:mpeg|mp4|ogg|webm)|audio\/(?:mp3|oga|ogg|opus)|file\/(?:pdf|doc|docx|ods|csv|xlsx));base64,[\d+/a-z]+=*$/i;
		...
		160: function (e, t, n) {
			! function (e, t, n) {
				...
				var R = ["background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href"],
					...
					B = /^data:(?:image\/(?:bmp|gif|jpeg|jpg|png|tiff|webp)|video\/(?:mpeg|mp4|ogg|webm)|audio\/(?:mp3|oga|ogg|opus)|file\/(?:pdf|doc|docx|ods|csv|xlsx));base64,[\d+/a-z]+=*$/i;
				...
				var f = function () {
					...
					h = function (e) {
						...
						return d(a, null, [{
							...
							value: function () {
								this.prototype.Emitter = f, this.prototype.events = ["drop", "dragstart", "dragend", "dragenter", "dragover", "dragleave", "addedfile", "addedfiles", "removedfile", "thumbnail", "error", "errormultiple", "processing", "processingmultiple", "uploadprogress", "totaluploadprogress", "sending", "sendingmultiple", "success", "successmultiple", "canceled", "canceledmultiple", "complete", "completemultiple", "reset", "maxfilesexceeded", "maxfilesreached", "queuecomplete"], this.prototype.defaultOptions = {
									...
									transformFile: function (e, t) {
										return (this.options.resizeWidth || this.options.resizeHeight) && e.type.match(/file.*/) && e.type.match(/image.*/) ? this.resizeImage(e, this.options.resizeWidth, this.options.resizeHeight, this.options.resizeMethod, t) : t(e)
									},
							...
							value: function (e) {
								var t = this;
								if (this.options.createImageThumbnails && e.type.match(/file.*/) && e.type.match(/image.*/) && e.size <= 1024 * this.options.maxThumbnailFilesize * 1024) return this._thumbnailQueue.push(e), setTimeout((function () {
							...
							value: function (e, t, n, i, o) {
								...
								return this.createThumbnail(e, t, n, i, !0, (function (t, n) {
									...
									return "image/jpeg" !== i && "image/jpg" !== i || (s = v.restore(e.dataURL, s)), o(a.dataURItoBlob(s))
								}))
							}
						}, {
							key: "createThumbnail",
				...
				var g = function (e, t, n, i, o, r, a, s, l, u) {
					...
					v = function () {
						...
						return d(e, null, [{
							...
							key: "restore",
							value: function (e, t) {
								if (!e.match("data:image/jpeg;base64,data:file/pdf;base64,")) return t;
								var n = this.decode64(e.replace("data:image/jpeg;base64,data:file/pdf;base64,", "")),
									i = this.slice2Segments(n),
									o = this.exifManipulation(t, i);
								return "data:image/jpeg;base64,data:file/pdf;base64,".concat(this.encode64(o))
							}
						}, {
							...
							key: "insertExif",
							value: function (e, t) {
								var n = e.replace("data:image/jpeg;base64,", "data:file/pdf;base64,", ""),
									i = this.decode64(n),
									o = i.indexOf(255, 3),
									r = i.slice(0, o),
									a = i.slice(o),
